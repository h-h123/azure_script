    ...
    try:
        ...
        for subscription_id in subscription_ids:
            ...
            for resource_group in resource_groups:
                ...
                # details_dict["Details"].append(f"Resource_Group:{resource_group.name}")
                details_dict["Details"][f"Resource_Group {resource_group.name}"] = resource_group.name
                ...
                for web_app in web_apps:
                    ...
                    if not auth_settings.enabled:
                        ...
                        details_dict["Details"][f"Vulnerability - App Service Authentication Disabled for WebApp '{web_app.name}'."] = web_app.name
                        ...
                        details_dict["Details"][f"App Service Authentication Enabled for WebApp '{web_app.name}'."] = web_app.name
                    ...
                    if auth_settings.unauthenticated_client_action == 'AllowAnonymous':
                        ...
                        details_dict["Details"][f"Vulnerability - Unauthenticated Client Action for WebApp '{web_app.name}' is set to Allow Anonymous"] = web_app.name
                    else:
                        ...
                        details_dict["Details"][f"Unauthenticated Client Action for WebApp '{web_app.name}' is not set to Allow Anonymous."] = web_app.name
                    ...
                    if not web_app_configuration.auto_heal_enabled:
                        ...
                        details_dict["Details"][f"Warning - If auto-healing is disabled then WebApp '{web_app.name}' might not recover automatically from failures which leads to potential downtime."] = web_app.name
                    else:
                        ...
                        details_dict["Details"][f"Auto heal feature is enabled for WebApp '{web_app.name}'"] = web_app.name
                    ...
                    if not web_app_configuration.http20_enabled:
                        ...
                        details_dict["Details"][f"Warning - HTTP2.0 is disabled for WebApp '{web_app.name}' which may impact the performance benefits provided by the protocol."] = web_app.name
                    else:
                        ...
                        details_dict["Details"][f"HTTP2.0 is Enabled for WebApp '{web_app.name}'"] = web_app.name
                    ...
                    if not float(web_app_configuration.min_tls_version) <= 1.2:
                        ...
                        details_dict["Details"][f"Warning - The TLS (Transport Layer Security) protocol for WebApp '{web_app.name}' secures transmission of data over the internet using standard encryption technology and encryption should be set with the latest version of TLS and here it is "] = web_app_configuration.min_tls_version
                    else:
                        ...
                        details_dict["Details"][f"TLS (Transport Layer Security) protocol version for WebApp '{web_app.name}' is "] = web_app_configuration.min_tls_version
                    ...
                    if web_app_configuration.public_network_access == "Enabled":
                        ...
                        details_dict["Details"][f"Vulnerability - Enabling public network access may expose the WebApp '{web_app.name}' to potential external threats."] = web_app.name
                    else:
                        ...
                        details_dict["Details"][f"Public Network access is disabled to the WebApp '{web_app.name}'"] = web_app.name
                    ...
                    if web_app_configuration.managed_service_identity_id is None:
                        ...
                        details_dict["Details"][f"Vulnerability: Managed Service Identity is not configured for WebApp '{web_app.name}' which leaves it potentially insecure."] = web_app.name
                    else:
                        ...
                        details_dict["Details"][f"Managed Service Identities is Enabled for WebApp '{web_app.name}' which is "] = web_app_configuration.managed_service_identity_id
