...
def check_network(subscription_ids):
    ...
    csv_file_path = "A_Demo_HTML_report2.csv"
    ...
    csv_file_path3 = 'New_report_Network.csv'
    json_path = "Network_data.json"
    ...
    try:
            ...
            for resource_group in resource_groups:
                ...
                try:
                    ...
                    for nsg in nsgs:
                        ...
                        details_dict["Details"][f"Resource_Group of NSG  `{resource_group.name}`"] = resource_group.name
                        ...
                        if len(allowed_rules) > 1:
                            ...
                            details_dict["Details"][f"Vulnerability Multiple rules of SSH, HTTP, RDP, HTTPS are allowed in the NSG `{nsg.name}`"] = nsg.name
                            ...
                            for rule in allowed_rules:
                                ...
                                details_dict["Details"][f"Allowed Protocols of nsg `{nsg.name}` and allowed rule is `{rule.name}`"] = rule.name
                            ...
                            if ssh_detected:
                                ...
                                details_dict["Details"][f"Warning Inbound SSH access is allowed for the NSG '{nsg.name}'in the resource group '{resource_group.name}'."] = nsg.name
                            ...
                            if udp_detected:
                                ...
                                details_dict["Details"][f"Warning Inbound UDP access is allowed for the NSG '{nsg.name}'in the resource group '{resource_group.name}'."] = nsg.name
                            ...
                            if rdp_detected:
                                ...
                                details_dict["Details"][f"Warning Inbound RDP access is allowed for the NSG '{nsg.name}'in the resource group '{resource_group.name}'."] = nsg.name
                    ...
                    details_dict["Details"]['Error checking NSG vulnerabilities']  = e
            ...
            ##############################################################
                ...
                try:
                    ...
                    for network_watcher in network_watchers:
                        ...
                        sentences3.append(f"\nChecking Network Watchers in '{resource_group.name}' Resource Group:")
                        # details_dict["Details"].append(f"Resource_Group:{resource_group.name}")
                        details_dict["Details"][f"Resource_Group of Network Watchers '{resource_group.name}'"] = resource_group.name
                        ...
                        if not network_watcher:
                            ...
                            details_dict["Details"][f"Vulnerability No Network Watchers found in the '{resource_group.name}' resource group. Network Watcher is disabled."] = resource_group.name
                        else:
                            ...
                            details_dict["Details"][f"Network Watcher named '{network_watcher.name}' is Enabled in the '{resource_group.name}' resource group."] = network_watcher.name
                        ...
                        if network_watcher.provisioning_state.lower() == 'succeeded':
                            ...
                            details_dict["Details"][f"Network Watcher named '{network_watcher.name}' is provisioned successfully."] = network_watcher.name
                        else:
                            ...
                            details_dict["Details"][f"Vulnerability: Network Watcher named '{network_watcher.name}' provisioning is not in a successful state."] = network_watcher.name
                    ...
                    details_dict["Details"]["Error checking network watchers"]= e
        ...
        details_dict["Details"]['Error in checking network resources '] = e
