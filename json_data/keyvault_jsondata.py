...
def check_key_vault_rbac(subscription_ids): 
    ...
    json_path = "KeyVault_&_RBAC_data.json"
            ...
            for resource_group in resource_groups:
                ...
                for keyvault in keyvaults:
                    ...
                    if keyvault.properties.enable_rbac_authorization:
                        ...
                        details_dict["Details"][f"Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' has RBAC enabled."] = keyvault.name
                    else:
                        ...
                        details_dict["Details"][f"Vulnerability - Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' does not have RBAC enabled."] = keyvault.name
                    ...
                    if keyvault.properties.enable_soft_delete:
                        ...
                        details_dict["Details"][f"Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' has key rotation enabled."] = keyvault.name
                    else:
                        ...
                        details_dict["Details"][f"Vulnerability - Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' does not have key rotation enabled."] = keyvault.name
                    ...
                    if keyvault.properties.private_endpoint_connections:
                        ...
                        details_dict["Details"][f"Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' has Private Endpoint connections."] = keyvault.name
                    else:
                        ...
                        details_dict["Details"][f"Vulnerability - Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' does not have Private Endpoint connections."] = keyvault.name
                    ...
                    if keyvault.properties.enable_soft_delete and keyvault.properties.enable_purge_protection:
                        ...
                        details_dict["Details"][f"Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' has automated recovery enabled."] = keyvault.name
                    else:
                        ...
                        details_dict["Details"][f"Vulnerability - Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' does not have automated recovery enabled."] = keyvault.name
                    ...
                    if network_acls and network_acls.default_action == 'Allow':
                        ...
                        details_dict["Details"][f"Vulnerability - Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' allows public network access."] = keyvault.name
                    else:
                        ...
                        details_dict["Details"][f"Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' does not allow public network access."] = keyvault.name
                    ...
                    if custom_owner_role_present:
                        ...
                        details_dict["Details"][f"Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' has a custom subscription owner role assigned."] = keyvault.name
                    else:
                        ...
                        details_dict["Details"][f"Warning - Azure Key Vault '{keyvault.name}' in Resource Group '{resource_group.name}' does not have a custom subscription owner role assigned."] = keyvault.name
